...
const { allVehicleMaintLog, createVehicleMaintLog, editVehicleMaintLog, planMaint, editPlannedMaint, allPlannedMaint, onePlannedMaint, addMaintPersonnelFeedback, editMaintPersonnelFeedback, addVehicleOwnersFeedback, updatePlannedMaintStatus, allMaintLog, allVehiclesPlannedMaint } = require('../controllers/maint-log-controller')
...
router.route('/all-vehicles-planned-maint').post(tokenDecoder, allVehiclesPlannedMaint)
